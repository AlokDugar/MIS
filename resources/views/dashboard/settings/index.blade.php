                                ...
                                <form action="{{ route('settings.update') }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if ($settings && $settings->site_logo)
                                            <img src="{{ asset('storage/' . $settings->site_logo) }}" height="80"
                                                class="mt-2">
                                        @endif
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if ($settings && $settings->dashboard_logo)
                                            <img src="{{ asset('storage/' . $settings->dashboard_logo) }}" height="80"
                                                class="mt-2">
                                        @endif
                                        <input type="file" name="dashboard_logo"
                                            class="form-control mt-3 @error('dashboard_logo') is-invalid @enderror">
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if ($settings && $settings->favicon)
                                            <img src="{{ asset('storage/' . $settings->favicon) }}" height="40"
                                                class="mt-2">
                                        @endif
                                        <input type="file" name="favicon"
                                            class="form-control mt-3 @error('favicon') is-invalid @enderror">
                                        @error('favicon')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
