                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Club Tags</li>
                        </ol>
                    </div>
                </div>
            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <ul class="action d-flex gap-2">
                                                        <li class="edit">
                                                            <a href="{{ route('club-tags.edit', $tag->id) }}"
                                                                title="Edit">
    ...
    <script>
        document.querySelectorAll('.delete-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                Swal.fire({
                    title: 'Are you sure?',
                    text: 'This club tag will be deleted!',
                    icon: 'warning',
                    ...
                    if (result.isConfirmed) {
                        ...
                        form.setAttribute('action', '/club-tags/' + tagId);
                        form.submit();
                    }
                });
            });
